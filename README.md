...
2. - Press `F12` Copy/Paste `@import url(https://jaythexxvii.github.io/RTL/RTL.css);` into the CSS prompt or;
   - In Spotify go to Marketplace > Snippets > + Add CSS & Paste the contents of [RTL.css](https://jaythexxvii.github.io/RTL/RTL.css) into the Custom CSS prompt & Save
